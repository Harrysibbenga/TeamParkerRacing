<template>
  <div>
    <div class="container text-center">
      <mdb-btn color="primary" class="ml-0" inline @click="newVideo">
        Add new video
      </mdb-btn>
    </div>
    ...
    >
      <mdb-modal-body class="text-center">
        ...
        {{ toDeleteItem.name }}
        <mdb-btn color="primary" @click.native="cancelDelete">
          Close
        </mdb-btn>
        <mdb-btn color="secondary" @click="confirmDelete">
          Delete
        </mdb-btn>
      </mdb-modal-body>
    </mdb-modal>
    ...
    <mdb-modal size="md" :show="uploadvideo" @close="closeVideoUpload">
      ...
      <mdb-modal-footer>
        ...
        <mdb-btn color="primary" size="sm" :disabled="img.alt == ''" @click="saveFile(type)">
          Save
        </mdb-btn>
      </mdb-modal-footer>
      <transition name="fade">
